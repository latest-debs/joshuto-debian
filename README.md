...
[![Release](https://img.shields.io/github/v/release/latest-debs/joshuto-debian)](https://github.com/latest-debs/joshuto-debian/releases)
[![Build](https://github.com/latest-debs/joshuto-debian/actions/workflows/release.yml/badge.svg)](../../actions)
...
```sh
sudo apt install ./joshuto_*.deb
```

## Verify

```sh
apt-cache policy joshuto
joshuto --version
```
...
For issues with joshuto itself, see
[joshuto](https://github.com/kamiyaa/joshuto).

## License

Packaging scripts in this repo are MIT-licensed. The packaged binaries
remain under their upstream license — see [joshuto](https://github.com/kamiyaa/joshuto).
